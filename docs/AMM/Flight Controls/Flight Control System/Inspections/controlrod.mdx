...
### 1. Elevator Control Rod Inspection
    * A. Remove the tunnel covers, ref [AMM Task 25-70-01-01](/AMM/Equipment/Panels/Maintenance Practices/tunnelcover).
...
### 2. Stick Base Inspections
    * A. Remove the front seats, ref [AMM Task 25-10-01-01](AMM/Equipment/Front Seats/Maintenance Practices/seatremoval) .
...
### 5. Rudder Cable Inspection
    * A. Remove the forward tunnel covers if required, ref [AMM Task 25-70-01-01](AMM/Equipment/Panels/Maintenance Practices/tunnelcover)
