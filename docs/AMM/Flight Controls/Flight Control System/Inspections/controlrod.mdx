...
### 1. Elevator Control Rod Inspection
    * A. Remove the tunnel covers, ref [AMM Task 25-70-01-01](/AMM/Equipment/Panels/Maintenance%20Practices/tunnelcover.mdx).
...
### 2. Stick Base Inspections
    * A. Remove the front seats, ref [AMM Task 25-10-01-01](AMM/Equipment/Front%20Seats/Maintenance%20Practices/seatremoval.mdx) .
...
### 5. Rudder Cable Inspection
    * A. Remove the forward tunnel covers if required, ref [AMM Task 25-70-01-01](AMM/Equipment/Panels/Maintenance%20Practices/tunnelcover.mdx)
